...
ystar <-(train$site_eui)^-1 #transformation
newdata <- data.frame(train,ystar)
result.ystar <- lm(ystar~Year_Factor + floor_area + year_built + energy_star_rating, data = train)
